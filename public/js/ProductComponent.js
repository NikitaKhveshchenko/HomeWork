...
Vue.component('product', {
    ...
    template: `<div class="product-item standart p-3" >
                <img :src="img" :alt="product.product_name" class="img__product img__cart">
                <div class="desc">
                    <h3 class="price-name text-white pt-3">{{ product.product_name }}</h3>
                    <div class="price d-flex justify-content-center align-items-end"><p>Цена:{{ product.price }} $</p></div>
